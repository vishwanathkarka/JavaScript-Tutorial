...
//chef  do nothing until waiter five an order
//if  person1 give an order to the waiter the waiter will tranfor the order to the chef the he will cook the food and tranfers to the waiter
// where the person1 don't have an contact with chef ,only waiter can contact with the chef
// waiter controls the chef
//customer don't have acces to kitchen or chef 
...
var resul = arr2.map((element)=> element+10) //map is used to modify data
console.log(resul)
console.log(arr2)
...
//Because all the function reseiving as a arguments
...
console.log(student.sno) //100
console.log(student['name'])//same concept to above in some casses we use this method
